...
exports.getOutgoingPaymentGrantSpentAmounts = exports.validateOutgoingPayment = exports.listOutgoingPayments = exports.createOutgoingPayment = exports.getOutgoingPayment = exports.createOutgoingPaymentRoutes = void 0;
...
const createOutgoingPaymentRoutes = (deps) => {
    ...
    let getGrantSpentAmountsOpenApiValidator;
    if (openApi) {
        ...
        getGrantSpentAmountsOpenApiValidator = openApi.createResponseValidator({
            path: (0, types_1.getRSPath)('/outgoing-payment-grant'),
            method: openapi_1.HttpMethod.GET
        });
    }
    return {
        ...
        getGrantSpentAmounts: (requestArgs) => (0, exports.getOutgoingPaymentGrantSpentAmounts)(baseDeps, requestArgs, getGrantSpentAmountsOpenApiValidator)
    };
};
...
const getOutgoingPaymentGrantSpentAmounts = async (deps, requestArgs, validateOpenApiResponse) => {
    const { url: baseUrl, accessToken } = requestArgs;
    const url = `${baseUrl}${(0, types_1.getRSPath)('/outgoing-payment-grant')}`;
    return await (0, requests_1.get)(deps, {
        url,
        accessToken
    }, validateOpenApiResponse);
};
exports.getOutgoingPaymentGrantSpentAmounts = getOutgoingPaymentGrantSpentAmounts;
