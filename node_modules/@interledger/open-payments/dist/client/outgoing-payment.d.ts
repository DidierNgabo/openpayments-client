...
import { CreateOutgoingPaymentArgs, OutgoingPayment, OutgoingPaymentGrantSpentAmounts, OutgoingPaymentPaginationResult, OutgoingPaymentWithSpentAmounts, PaginationArgs } from '../types';
export interface OutgoingPaymentRoutes {
    ...
    getGrantSpentAmounts(args: ResourceRequestArgs): Promise<OutgoingPaymentGrantSpentAmounts>;
}
...
export declare const getOutgoingPayment: (deps: BaseDeps, requestArgs: ResourceRequestArgs, validateOpenApiResponse: ResponseValidator<OutgoingPayment>) => Promise<{
    ...
    sentAmount: import("../openapi/generated/resource-server-types").components["schemas"]["amount"];
    metadata?: {
        [key: string]: unknown;
    };
    createdAt: string;
...
export declare const getOutgoingPaymentGrantSpentAmounts: (deps: BaseDeps, requestArgs: ResourceRequestArgs, validateOpenApiResponse: ResponseValidator<OutgoingPaymentGrantSpentAmounts>) => Promise<OutgoingPaymentGrantSpentAmounts>;
