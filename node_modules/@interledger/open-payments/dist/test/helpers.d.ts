...
import { IncomingPayment, GrantRequest, GrantContinuationRequest, OutgoingPayment, OutgoingPaymentGrantSpentAmounts, OutgoingPaymentPaginationResult, WalletAddress, JWK, AccessToken, Quote, IncomingPaymentPaginationResult, PendingGrant, Grant, IncomingPaymentWithPaymentMethods, IlpPaymentMethod, PublicIncomingPayment, DIDDocument, OutgoingPaymentWithSpentAmounts, Subject } from '../types';
...
export declare const mockOutgoingPaymentGrantSpentAmounts: (overrides?: Partial<OutgoingPaymentGrantSpentAmounts>) => OutgoingPaymentGrantSpentAmounts;
...
export declare const mockSubject: (overrides?: Partial<Subject>) => Subject;
